...
{
    /// <summary>
    /// User control to display messages
    /// </summary>
    public partial class Outbox : UserControl
    {
        ...
        private void PollMessages(object obj)
        {
            ...
            IOrderedQueryable<OutgoingMessage> results = OutgoingMessage.All().Where
                (msg => msg.Status != StringEnum.GetStringValue(MessageStatus.Archived) &&
                 msg.Status != StringEnum.GetStringValue(MessageStatus.Failed) && msg.LastUpdate > this.lastUpdateTimestamp).OrderByDescending(msg => msg.LastUpdate);
