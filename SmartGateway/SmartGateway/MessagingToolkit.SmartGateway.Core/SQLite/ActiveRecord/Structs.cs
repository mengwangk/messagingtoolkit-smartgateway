...
namespace MessagingToolkit.SmartGateway.Core.Data.ActiveRecord {
        ...
        public class DbMessengerTable: DatabaseTable {
            
            public DbMessengerTable(IDataProvider provider):base("DbMessenger",provider){
                ClassName = "DbMessenger";
                SchemaName = "";
                ...
                Columns.Add(new DatabaseColumn("Dsn", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = false,
                ...
                Columns.Add(new DatabaseColumn("DbTable", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = false,
                ...
                Columns.Add(new DatabaseColumn("PollingInterval", this)
                {
	                IsPrimaryKey = false,
                ...
                Columns.Add(new DatabaseColumn("RequiredAuth", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.Boolean,
	                IsNullable = false,
                ...
                Columns.Add(new DatabaseColumn("DbUserName", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
                ...
                Columns.Add(new DatabaseColumn("DbUserPassword", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
                ...
                Columns.Add(new DatabaseColumn("UniqMsgIdColName", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = false,
                ...
                Columns.Add(new DatabaseColumn("UniqMsgIdColDataType", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = false,
                ...
                Columns.Add(new DatabaseColumn("MsgColName", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
                ...
                Columns.Add(new DatabaseColumn("DestNoColName", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = false,
                ...
                Columns.Add(new DatabaseColumn("MsgPriorityColName", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
                ...
                Columns.Add(new DatabaseColumn("MsgAlertColName", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
                ...
                Columns.Add(new DatabaseColumn("DefaultMsgPriority", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
                ...
                Columns.Add(new DatabaseColumn("DefaultTextMsg", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
                ...
                Columns.Add(new DatabaseColumn("DeleteAfterSending", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.Boolean,
	                IsNullable = false,
                ...
                Columns.Add(new DatabaseColumn("StatusColName", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
                ...
                Columns.Add(new DatabaseColumn("StatusTimestampColName", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
                ...
                Columns.Add(new DatabaseColumn("StatusColNewValue", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
                ...
                Columns.Add(new DatabaseColumn("StatusColUpdateSuccessVal", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
                ...
                Columns.Add(new DatabaseColumn("StatusColUpdateFailedValue", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
                ...
                Columns.Add(new DatabaseColumn("StatusColUpdateSendingValue", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.AnsiString,
	                IsNullable = true,
                ...
                Columns.Add(new DatabaseColumn("AutoStart", this)
                {
	                IsPrimaryKey = false,
	                DataType = DbType.Boolean,
	                IsNullable = false,
            ...
            public IColumn Dsn{
                get{
                    return this.GetColumn("Dsn");
                }
            }
				
   			public static string DsnColumn{
			      get{
        			return "Dsn";
      			}
		    }
            
            public IColumn DbTable{
                get{
                    return this.GetColumn("DbTable");
                }
            }
				
   			public static string DbTableColumn{
			      get{
        			return "DbTable";
      			}
		    }
            
            public IColumn PollingInterval{
                get{
                    return this.GetColumn("PollingInterval");
                }
            }
				
   			public static string PollingIntervalColumn{
			      get{
        			return "PollingInterval";
      			}
		    }
            
            public IColumn RequiredAuth{
                get{
                    return this.GetColumn("RequiredAuth");
                }
            }
				
   			public static string RequiredAuthColumn{
			      get{
        			return "RequiredAuth";
      			}
		    }
            
            public IColumn DbUserName{
                get{
                    return this.GetColumn("DbUserName");
                }
            }
				
   			public static string DbUserNameColumn{
			      get{
        			return "DbUserName";
      			}
		    }
            
            public IColumn DbUserPassword{
                get{
                    return this.GetColumn("DbUserPassword");
                }
            }
				
   			public static string DbUserPasswordColumn{
			      get{
        			return "DbUserPassword";
      			}
		    }
            
            public IColumn UniqMsgIdColName{
                get{
                    return this.GetColumn("UniqMsgIdColName");
                }
            }
				
   			public static string UniqMsgIdColNameColumn{
			      get{
        			return "UniqMsgIdColName";
      			}
		    }
            
            public IColumn UniqMsgIdColDataType{
                get{
                    return this.GetColumn("UniqMsgIdColDataType");
                }
            }
				
   			public static string UniqMsgIdColDataTypeColumn{
			      get{
        			return "UniqMsgIdColDataType";
      			}
		    }
            
            public IColumn MsgColName{
                get{
                    return this.GetColumn("MsgColName");
                }
            }
				
   			public static string MsgColNameColumn{
			      get{
        			return "MsgColName";
      			}
		    }
            
            public IColumn DestNoColName{
                get{
                    return this.GetColumn("DestNoColName");
                }
            }
				
   			public static string DestNoColNameColumn{
			      get{
        			return "DestNoColName";
      			}
		    }
            
            public IColumn MsgPriorityColName{
                get{
                    return this.GetColumn("MsgPriorityColName");
                }
            }
				
   			public static string MsgPriorityColNameColumn{
			      get{
        			return "MsgPriorityColName";
      			}
		    }
            
            public IColumn MsgAlertColName{
                get{
                    return this.GetColumn("MsgAlertColName");
                }
            }
				
   			public static string MsgAlertColNameColumn{
			      get{
        			return "MsgAlertColName";
      			}
		    }
            
            public IColumn DefaultMsgPriority{
                get{
                    return this.GetColumn("DefaultMsgPriority");
                }
            }
				
   			public static string DefaultMsgPriorityColumn{
			      get{
        			return "DefaultMsgPriority";
      			}
		    }
            
            public IColumn DefaultTextMsg{
                get{
                    return this.GetColumn("DefaultTextMsg");
                }
            }
				
   			public static string DefaultTextMsgColumn{
			      get{
        			return "DefaultTextMsg";
      			}
		    }
            
            public IColumn DeleteAfterSending{
                get{
                    return this.GetColumn("DeleteAfterSending");
                }
            }
				
   			public static string DeleteAfterSendingColumn{
			      get{
        			return "DeleteAfterSending";
      			}
		    }
            
            public IColumn StatusColName{
                get{
                    return this.GetColumn("StatusColName");
                }
            }
				
   			public static string StatusColNameColumn{
			      get{
        			return "StatusColName";
      			}
		    }
            
            public IColumn StatusTimestampColName{
                get{
                    return this.GetColumn("StatusTimestampColName");
                }
            }
				
   			public static string StatusTimestampColNameColumn{
			      get{
        			return "StatusTimestampColName";
      			}
		    }
            
            public IColumn StatusColNewValue{
                get{
                    return this.GetColumn("StatusColNewValue");
                }
            }
				
   			public static string StatusColNewValueColumn{
			      get{
        			return "StatusColNewValue";
      			}
		    }
            
            public IColumn StatusColUpdateSuccessVal{
                get{
                    return this.GetColumn("StatusColUpdateSuccessVal");
                }
            }
				
   			public static string StatusColUpdateSuccessValColumn{
			      get{
        			return "StatusColUpdateSuccessVal";
      			}
		    }
            
            public IColumn StatusColUpdateFailedValue{
                get{
                    return this.GetColumn("StatusColUpdateFailedValue");
                }
            }
				
   			public static string StatusColUpdateFailedValueColumn{
			      get{
        			return "StatusColUpdateFailedValue";
      			}
		    }
            
            public IColumn StatusColUpdateSendingValue{
                get{
                    return this.GetColumn("StatusColUpdateSendingValue");
                }
            }
				
   			public static string StatusColUpdateSendingValueColumn{
			      get{
        			return "StatusColUpdateSendingValue";
      			}
		    }
            
            public IColumn AutoStart{
                get{
                    return this.GetColumn("AutoStart");
                }
            }
				
   			public static string AutoStartColumn{
			      get{
        			return "AutoStart";
      			}
		    }
